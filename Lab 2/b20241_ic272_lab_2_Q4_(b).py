...
# using interpolate() to fill missing values with mean of respective attributes
...
# saving interpolated dataframe for solving problem 5 with name "landslide_data3_interpolated.csv"
df.to_csv("landslide_data3_interpolated.csv", index=False)
